<template>
    <div class="main-wrapper  mb-2">
        ...
        <div class="text-right mb-25">
            <button type="button" class="button button-dark" @click="showModal">Create new user</button>
        </div>
        <div class="col-md-12">
        ...
        <SideModal :content="content" :showing="showing" @hideModal="showing=false">
            <CreateUser :formData="formData" :data="data" :editData="false"></CreateUser>
        </SideModal>
<!--        {{editData}}-->
...
<script>
    ...
    export default {
        props: ['data'],
        components: {
            Button, HasError, AlertError, Link, CreateUser, SideModal, DataTable,Pagination
        },
