<template>
    ...
    <div class="main-wrapper">
        ...
        <div class="text-right mb-25">
            <button type="button" class="button button-dark" @click="showModal">Create new role</button>
        </div>
        <div class="col-md-12">
        ...
        <SideModal :content="content" :showing="showing" @hideModal="showing=false">
            <CreateRole :formData="formData" :data="data" :editData="false" @hideModal="showing=false"></CreateRole>
        </SideModal>
...
<script>
    ...
    export default {
        props: ['data'],
        components: {
            Button, HasError, AlertError, Link, CreateRole, SideModal, DataTable , Pagination
        },
